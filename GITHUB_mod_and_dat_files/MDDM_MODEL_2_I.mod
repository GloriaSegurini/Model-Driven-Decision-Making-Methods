 ...
 * OPL 22.1.1.0 Model
 * Author: User
 * Creation Date: 26 ott 2023 at 17:56:36
 *********************************************/
/*********************************************
 * OPL 22.1.1.0 Model
...
//dvar float r[G][I]; //variable for renewable energy NB REMOVE
...
subject to {
   ...
   forall (g in G) ////NB/////
     d[g] <= sum(i in I) c[i,g] + sum(j in J) t[g,j];
     
     
   //forall (g in G, i in I)
     //r[g,i] <= c[i,g]; //////NB////// REMOVE
